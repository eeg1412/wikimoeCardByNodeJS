            ...
            <tr v-for="(item,index) in mineMap"
              ...
              <td v-for="(items,indexs) in item"
                ...
                <div class="wm_demining_item"
                     ...
                     :style="'background-image:url(/static/otherImg/demining/bg'+mineInfo.data.mapType+'.png)'">
                  <el-tooltip class="item"
                              effect="dark"
                              :content="items.num==9?'这里是一片星星矿':'探测器显示周围有'+items.num+'片星星矿！'"
                              placement="top"
                              v-if="items.num>=0"
                              :enterable="false">
                    <div>
      ...
      <div class="wm_menu_news_body">
        ...
        <div v-else>
          <div v-for="(item,index) in userList"
            ...
            <div class="wm_dem_ueser_img"><img class="wm_card_get_list_avatar_pic"
