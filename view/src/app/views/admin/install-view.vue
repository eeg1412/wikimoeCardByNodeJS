    ...
    <el-form ref="form"
      ...
      <el-form-item label="管理员账号">
        <el-input v-model="form.account"
                  placeholder="请设定管理员账号"></el-input>
      </el-form-item>
      <el-form-item label="管理员密码">
        <el-input v-model="form.password"
                  show-password
                  placeholder="请设定管理员密码"></el-input>
      </el-form-item>
      <el-form-item label="每日抽卡次数">
        <el-input v-model="form.dailyChance"
                  placeholder="请设定每日抽卡次数"
                  type="number"></el-input>
      </el-form-item>
      <el-form-item label="邮件发送host">
        <el-input v-model="form.smtpHost"
                  placeholder="请设定邮件发送host地址"></el-input>
      </el-form-item>
      ...
      <el-form-item label="邮箱账户">
        <el-input v-model="form.smtpAuthUser"
                  placeholder="请设定邮箱账户"></el-input>
      </el-form-item>
      <el-form-item label="邮箱密码">
        <el-input v-model="form.smtpAuthPass"
                  show-password
                  placeholder="请设定邮箱密码"></el-input>
      </el-form-item>
      <el-form-item label="session">
        <el-input v-model="form.sessionSecret"
                  placeholder="用于session加密的字符串"></el-input>
      </el-form-item>
      <el-form-item label="JWTSecret">
        <el-input v-model="form.JWTSecret"
                  placeholder="用于JWT加密字符串"></el-input>
      </el-form-item>
      <el-form-item label="机器人验证送的星星">
        <el-input-number v-model="form.robotCheckStar"
                         label="机器人验证通过后送的星星"
                         :min="1"></el-input-number>
      </el-form-item>
      <el-form-item label="低于该可疑度送星星">
        <el-input-number v-model="form.robotCheckCanGetStar"
                         label="机器人可疑度低于这个值送星星"
                         :min="1"></el-input-number>
      </el-form-item>
      <el-form-item label="挖矿得星星倍率">
        <el-input-number v-model="form.deminingStarRatio"
                         label="挖矿获得星星的倍率"
                         :min="1"></el-input-number>
      </el-form-item>
      <el-form-item label="挖矿得宝石倍率">
        <el-input-number v-model="form.deminingItemRatio"
                         label="挖矿获得宝石的倍率"
                         :min="1"></el-input-number>
      </el-form-item>
      <el-form-item label="制卡审核通过送的星星">
        <el-input-number v-model="form.creatCardStar"
                         label="制卡审核通过后获得的星星"
                         :min="1"></el-input-number>
      </el-form-item>
      <el-form-item label="单用户最多等待审核的制卡">
        <el-input-number v-model="form.creatCardWait"
                         label="单用户最多等待审核的制卡"
                         :min="1"></el-input-number>
      </el-form-item>
      ...
      <el-form-item label="竞技榜单结缘币基数">
        <el-input-number v-model="form.battleRankGetItem"
                         label="竞技第一名额外获得结缘币的数量"
                         :min="1"></el-input-number>
      </el-form-item>
      <el-form-item label="竞技榜单结缘币基数衰减">
        <el-input-number v-model="form.battleRankGetItemDecay"
                         label="竞技榜单结缘币基数衰减"
                         :min="1"></el-input-number>
      </el-form-item>
      <el-form-item label="同时存在多少矿场">
        <el-input-number v-model="form.deminingCount"
                         label="同时存在多少矿场"
                         :min="1"></el-input-number>
      </el-form-item>
      <el-form-item label="捐赠图片URL地址">
        <el-input v-model="form.donateImgUrl"
                  placeholder="捐赠图片URL地址（选填）"></el-input>
      </el-form-item>
      <el-form-item label="制卡说明图片URL地址">
        <el-input v-model="form.creatCardExplainUrl"
                  placeholder="制卡说明图片URL地址（选填）"></el-input>
      </el-form-item>
      <el-form-item label="加群链接">
        <el-input v-model="form.QQunURL"
                  placeholder="加群链接（选填）"></el-input>
      </el-form-item>
      <el-form-item label="教程链接">
        <el-input v-model="form.courseURL"
                  placeholder="教程链接（选填）"></el-input>
      </el-form-item>
      <el-form-item label="浏览器标签标题">
        <el-input v-model="form.browserTitle"
                  placeholder="浏览器标签标题"></el-input>
      </el-form-item>
