  ...
  <div class="wmcard_admincenter_common_right_body">
    <el-form ref="form"
      ...
      <el-form-item label="每日抽卡次数">
        <el-input-number v-model="form.dailyChance"
                         label="请设定每日抽卡次数"
      ...
      <el-form-item label="底部信息">
        <el-input type="textarea"
                  :rows="5"
                  v-model="form.footer"
                  placeholder="(支持html，可用于添加流量统计代码)"></el-input>
      </el-form-item>
    ...
    getSettingInfo () {
      ...
      authApi.adminsetting(params).then(res => {
        ...
        if (res.data.code == 1) {
          ...
          this.form.battleRankGetItemDecay = resData.battleRankGetItemDecay || '10';//后面陆续获得结缘币的衰减数量
