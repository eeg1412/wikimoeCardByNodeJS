...
<div class="wmcard_admincenter_common_right_body">
  <div class="wm_handbook_cardlist wm_admin_giveitem_body">
        ...
        <div v-if="cardBook.length>0" ref="cardList">
            <el-table
                :data="cardBook"
                border
                style="width: 100%">
                ...
                header-align="center">
                    <template slot-scope="scope">
                        <el-tooltip placement="right">
                            <div slot="content"><img :src="$wikimoecard.url+scope.row.packageId+'/'+scope.row.cardId+'.jpg?time='+timeStamp" class="wm_admin_cardmanage_watchcard" /></div>
                            <div class="tc">
                                <img :src="$wikimoecard.url+scope.row.packageId+'/'+scope.row.cardId+'.jpg?time='+timeStamp" width="80px" :key="scope.row.cardId">
                            </div>
                ...
                header-align="center">
                    <template slot-scope="scope">
                        <div class="tc"><img :src="'https://gravatar.loli.net/avatar/'+scope.row.md5+'?s=100&amp;d=mm&amp;r=g&amp;d=robohash&days='+txDays" width="50px" height="50px"/><div class="mt5">{{scope.row.auther}}</div></div>
                    </template>
                </el-table-column>
                <el-table-column
                label="操作"
    ...
    <el-dialog
        ...
        <div>
            <adminCardEditor :editorData="editorData" @cardUpdated="getCardData()" ref="adminCardEditor"></adminCardEditor>
        </div>
        <span slot="footer" class="dialog-footer">
            <el-button type="primary" @click="editCard()">修改</el-button>
        </span>
    </el-dialog>
</div>
</template>
