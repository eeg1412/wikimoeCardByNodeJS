...
export default {
  ...
  methods: {
    send(){
      ...
      this.$confirm('猜卡将消耗78星星, 是否继续?', '提示', {
    ...
    help(){
      this.$alert('系统每个整点会自动生成30张卡牌并自动结算上个整点选中的6张卡牌。<br />每位大佬可以选择6张心仪的卡牌，点击【猜卡】按钮消费78颗星星上传选中的卡牌。<br />然后等下一个整点公布结果后在【兑换】选项卡中兑换奖品。<br />系统将会根据猜中卡牌的张数发放对应的星星，同时还会获得猜中的卡牌。<br />奖品如下：<br />猜中零张卡牌：随机宝石×2。<br />猜中一张卡牌：1颗星星+猜中的卡牌。<br />猜中两张卡牌：5颗星星+猜中的卡牌。<br />猜中三张卡牌：80颗星星+猜中的卡牌。<br />猜中四张卡牌：2500颗星星+猜中的卡牌。<br />猜中五张卡牌：50万颗星星+猜中的卡牌。<br />猜中六张卡牌：500万颗星星+猜中的卡牌。', {
