<template>
  <div class="common_body">
      ...
      <div class="shop_card_list_body" v-if="openList">
        <div class="shop_card_list_btn_body" id="shopCardListBtnBody">
          <div class="shop_card_list_btn_box" :class="shopCardListBtnBodyFixed?'flex_mode':''">
            <el-button type="primary" @click="back()">返回结缘</el-button>
    ...
    <el-collapse-transition>
      <div class="wm_shop_item_list_body type_goen" v-if="!openList">
        <div class="wm_shop_item_list_box">
          <div class="wm_goen_saiqian_box mb10">
            ...
            <img src="/static/otherImg/goen/goen2.gif" class="wm_goen_saiqian_img type_c" />
          </div>
          <div class="tc mb10">
