<template>
  <div class="wm_card_rank_body" id="wmCardRankBody" v-if="changed && rankData" @mouseenter="$wikimoecard.l2dMassage('这些排行榜中的大佬们真是太厉害了呢！')">
    <el-carousel :interval="4000" :type="card" height="420px" :indicator-position="'outside'" :arrow="'never'" :trigger="'click'" v-if="rankData.cardIndexCount.length>=5">
      <el-carousel-item>
        <div class="wm_card_rank_item_box" id="wmCardRankBox">
          ...
          <div class="wm_card_rank_list">
            <div class="clearfix wm_card_rank_box" v-for="(item,index) in rankData.cardIndexCount" v-bind:key="index" @click="watchInfo(item.md5)">
      ...
      <el-carousel-item>
        <div class="wm_card_rank_item_box" id="wmDeminingRankBox">
          <h5 class="wm_card_chiose_title" id="wm_card_rank_title">星星榜</h5>
          <p class="wm_card_rank_last_updata">
            最后更新：
            <span class="wm_card_rank_last_time">{{rankData.time|capitalize}}</span>
          </p>
          <div class="wm_card_rank_list">
            <div class="clearfix wm_card_rank_box" v-for="(item,index) in rankData.star" v-bind:key="index" @click="watchInfo(item.md5)">
              <div class="fl wm_card_rank_text">{{index+1|rankTetx}}</div>
              <div class="fl wm_card_rank_img">
                <img
                  class="wm_card_get_list_avatar_pic"
      ...
      <el-carousel-item>
        <div class="wm_card_rank_item_box" id="wmDeminingRankBox">
          ...
          <div class="wm_card_rank_list">
            <div class="clearfix wm_card_rank_box" v-for="(item,index) in rankData.deminingStarCount" v-bind:key="index" @click="watchInfo(item.md5)">
              <div class="fl wm_card_rank_text">{{index+1|rankTetx}}</div>
              <div class="fl wm_card_rank_img">
                <img
                  class="wm_card_get_list_avatar_pic"
      ...
      <el-carousel-item>
        <div class="wm_card_rank_item_box" id="wmScoreRankBox">
          ...
          <div class="wm_card_rank_list">
            <div class="clearfix wm_card_rank_box" v-for="(item,index) in rankData.score" v-bind:key="index" @click="watchInfo(item.md5)">
              <div class="fl wm_card_rank_text">{{index+1|rankTetx}}</div>
              <div class="fl wm_card_rank_img">
                <img
                  class="wm_card_get_list_avatar_pic"
      ...
      <el-carousel-item>
        <div class="wm_card_rank_item_box" id="wmDeminingRankBox">
          <h5 class="wm_card_chiose_title" id="wm_card_rank_title">猜卡榜</h5>
          <p class="wm_card_rank_last_updata">
            最后更新：
            <span class="wm_card_rank_last_time">{{rankData.time|capitalize}}</span>
          </p>
          <div class="wm_card_rank_list">
            <div class="clearfix wm_card_rank_box" v-for="(item,index) in rankData.guessCardCount" v-bind:key="index" @click="watchInfo(item.md5)">
              <div class="fl wm_card_rank_text">{{index+1|rankTetx}}</div>
              <div class="fl wm_card_rank_img">
                <img
                  class="wm_card_get_list_avatar_pic"
      ...
      <el-carousel-item>
        <div class="wm_card_rank_item_box" id="wmLevelRankBox">
          ...
          <div class="wm_card_rank_list">
            <div class="clearfix wm_card_rank_box" v-for="(item,index) in rankData.level" v-bind:key="index" @click="watchInfo(item.md5)">
              <div class="fl wm_card_rank_text">{{index+1|rankTetx}}</div>
              <div class="fl wm_card_rank_img">
                <img
                  class="wm_card_get_list_avatar_pic"
      ...
      <el-carousel-item>
        <div class="wm_card_rank_item_box" id="wmLevelRankBox">
          ...
          <div class="wm_card_rank_list">
            <div class="clearfix wm_card_rank_box" v-for="(item,index) in rankData.UCC" v-bind:key="index" @click="watchInfo(item.md5)">
              <div class="fl wm_card_rank_text">{{index+1|rankTetx}}</div>
              <div class="fl wm_card_rank_img">
                <img
                  class="wm_card_get_list_avatar_pic"
