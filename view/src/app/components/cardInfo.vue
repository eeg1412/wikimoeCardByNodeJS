...
<div>
    <el-dialog
        ...
        top="50px"
        width="852px">
        <el-row :gutter="20" v-if="cardData">
            <el-col :sm="12" :xs="24" class="mb10">
                <div>
                    <img class="wm_handbook_info_img" :src="this.$wikimoecard.url+cardData.packageId+'/'+cardData.cardId+'.jpg'" :key="cardData.cardId" />
                </div>
            </el-col>
            <el-col :sm="12" :xs="24" v-show="buyMode">
                <div>
                    <el-table
                        :data="cardList"
                        max-height="319"
                        ...
                        width="80">
                            <template slot-scope="scope">
                                <el-button type="primary" size="mini" @click="buyCard(scope.row)">购买</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </div>
                <div>
                    <div class="tc mt10" v-if="cardTotle">
                        <el-pagination
                        small
                ...
                <div class="mt10 wm_cardinfo_wantcard_body">
                    ...
                    <el-form ref="form" label-width="80px">
                        <el-form-item label="期望星星" style="margin-bottom:0px">
                            <el-input-number  class="wm_market_card_datail_price_input_box" size="medium" v-model="wantPrice" :precision="0" :step="1" :max="99999999" :min="minPriceCal(cardData.star)"></el-input-number>
                        </el-form-item>
                    </el-form>
                    <el-button type="primary" class="w_10 mt10 mb10" @click="wantCard()">求卡</el-button>
                </div>
            </el-col>
            <el-col :sm="12" :xs="24" v-show="!buyMode">
                <div class="wm_handbook_cardinfo_body type_cardinfo">
                    ...
                    <div class="wm_handbook_cardinfo_item" v-if="cardData.level">卡牌等级：{{cardData.level+1}}级</div>
                ...
                <div class="wm_market_card_datail_charts type_cardinfo_dialog mt10">
                    <ve-line :data="chartData" :settings="chartSettings" :extend="extend" v-if="chartData.rows.length>0" :colors="colors" height="280px"></ve-line>
                    <div class="wm_market_card_datail_charts_empty type_cardinfo_dialog" v-else>暂无价格历史数据</div>
                </div>
            </el-col>
        </el-row>
        <span slot="footer" class="dialog-footer">
            <el-button type="primary" @click="goMarket">{{buyMode?'卡牌详情':'购卡或求卡'}}</el-button>
