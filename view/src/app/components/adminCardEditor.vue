<template>
<div>
    <h6 class="common_title_tips type_dec">Tip:当前字体库为延时加载，请先确认字体是否有异样后再保存。</h6>
    <div class="mt20">
        <el-row>
            <el-col :sm="12">
                <div class="wm_creatcard_body">
                    <div class="tc mb10" v-show="!editPic">
                        <img :src="$wikimoecard.url+cardSet.packageId+'/'+cardSet.cardId+'.jpg?time='+timeStamp" class="wm_admin_cardmanage_watchcard" />
                    </div>
                    <div id="wmCreatCard" class="tc" v-show="editPic"></div>
                </div>
                <div class="wm_creatcard_btn_body">
                    <el-button size="mini" type="primary" @click="editPicMethods" v-show="!editPic">更改立绘和属性</el-button>
                    <el-button size="mini" class="ml5" @click="editPicCloseMethods" v-show="editPic">取消更改</el-button>
                </div>
            </el-col>
            <el-col :sm="12" class="wm_admin_card_editor_form_body">
                <el-form class="wm_creatcard_form" label-width="80px">
                    ...
                    <el-form-item label="立绘旋转" v-show="editPic&&!rawPicMode">
                    ...
                    <el-form-item label="邮箱MD5">
                        <el-input v-model="cardSet.md5" @input="changeTitle" class="wm_append_btn" placeholder="点击生成，生成作者邮箱MD5" readonly>
                    ...
                    <el-form-item label="星级">
                        <el-select v-model="cardSet.star" placeholder="请选择星级" @change="changeStar" :disabled="!editPic">
                    ...
                    <el-form-item label="水晶">
                        <el-select v-model="cardSet.cry" placeholder="请选择水晶" @change="changeCry" :disabled="!editPic">
                    ...
                    <el-form-item label="被动属性">
                        <el-select v-model="cardSet.leftType" placeholder="请选择被动属性" @change="changeLeftType" :disabled="!editPic">
                    ...
                    <el-form-item label="主动技能">
                        <el-select v-model="cardSet.rightType" placeholder="请选择主动技能" @change="changeRightType" :disabled="!editPic">
