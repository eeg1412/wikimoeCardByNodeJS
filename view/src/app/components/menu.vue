...
<div>
  <div class="wm_card_menu_body">
    ...
    <div class="wm_card_menu_box" @click="login('/dailygetitem')" v-if="$route.path!='/dailygetitem'" @mouseover="$wikimoecard.l2dMassage('每日签到可以获得丰厚的奖励喔！')" @mouseout="$wikimoecard.l2dMassageClose">
      <div class="wm_card_menu_ico">
