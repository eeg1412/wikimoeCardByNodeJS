...
<div>
  <div class="wm_card_menu_body">
    <div class="wm_card_menu_box" @click="goHome()" v-if="$route.path!='/'" @mouseenter="$wikimoecard.l2dMassage('回到首页')" @mouseleave="$wikimoecard.l2dMassageClose">
      <div class="wm_card_menu_ico">
        <img src="../../assets/images/menu/home.jpg" width="100%" height="100%" />
      </div>
      <div class="wm_card_menu_text">首页</div>
    </div>
    <div class="wm_card_menu_box" @click="goCouse()" @mouseenter="$wikimoecard.l2dMassage('查看游戏教程，推荐新手玩家必读！')" @mouseleave="$wikimoecard.l2dMassageClose">
      <div class="wm_card_menu_ico">
    ...
    <div class="wm_card_menu_box" @click="login('/star/market')" v-if="$route.path.indexOf('/star/market')==-1" @mouseenter="$wikimoecard.l2dMassage('市场可以自由买卖卡牌哦！')" @mouseleave="$wikimoecard.l2dMassageClose">
      <div class="wm_card_menu_ico">
        <img src="../../assets/images/menu/market.png" width="100%" height="100%" />
      </div>
      <div class="wm_card_menu_text">市场</div>
    </div>
    <div class="wm_card_menu_box" @click="login('/decompose')" v-if="$route.path.indexOf('/decompose')==-1" @mouseenter="$wikimoecard.l2dMassage('可以分解各种不需要的卡牌和道具！')" @mouseleave="$wikimoecard.l2dMassageClose">
      <div class="wm_card_menu_ico">
        <img src="../../assets/images/menu/decompose.png" width="100%" height="100%" />
      </div>
      <div class="wm_card_menu_text">分解</div>
    </div>
    <div class="wm_card_menu_box" @click="openNews" @mouseenter="$wikimoecard.l2dMassage('可以查看游戏内的公告！')" @mouseleave="$wikimoecard.l2dMassageClose">
      <div class="wm_card_menu_ico">
    ...
    <div class="wm_card_menu_box" @click="login('/creatcard')" v-if="$route.path.indexOf('/creatcard')==-1" @mouseenter="$wikimoecard.l2dMassage('可以制作属于自己的卡牌哦！')" @mouseleave="$wikimoecard.l2dMassageClose">
      <div class="wm_card_menu_ico">
